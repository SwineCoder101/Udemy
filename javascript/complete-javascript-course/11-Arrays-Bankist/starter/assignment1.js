...
const checkDogs = function (dogsJulia, dogsKate) {
  //1
  let dogsOnlyJulia = dogsJulia.slice(1);
  dogsOnlyJulia.splice(-2);
  console.log('==========TEST=================');
  console.log(`Julias all pet ages: ${dogsJulia}`);
  console.log(`Julias dog ages validated: ${dogsOnlyJulia}`);
  console.log(`Kates dog ages: ${dogsKate}`);

  dogsOnlyJulia.concat(dogsKate).forEach(age => {
    if (age > 3) {
    }
  });
};
...
checkDogs(julia.data2, kate.data2);
