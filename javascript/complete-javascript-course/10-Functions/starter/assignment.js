...
it is, using console.log(). This should be the default option. If type is 
...
const pollTestInput = {
  ...
  setAnswers(data = 1) {
    data === 1
      ? (this.answers = this.TestData1)
      : (this.answers = this.TestData2);
  },
};
...
pollTestInput.setAnswers(2);
poll.displayResults.call(pollTestInput);
